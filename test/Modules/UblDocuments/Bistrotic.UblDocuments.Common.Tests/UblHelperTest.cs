namespace Bistrotic.UblDocuments.Tests
{
    ...
    public class UblHelperTest
    {
        ...
        public void UblInvoice_2_1_from_embedded_check()
        {
            ...
            DateTimeOffset issueTime = invoice.IssueTime;
            issueTime.Hour.Should().Be(16);
            issueTime.Minute.Should().Be(29);
            issueTime.Second.Should().Be(05);
            DateTime dueDate = invoice.DueDate;
            dueDate.Year.Should().Be(2021);
            dueDate.Month.Should().Be(4);
            dueDate.Day.Should().Be(3);
            invoice.InvoiceTypeCode.Should().Be("01");
            invoice.Note.Should().StartWith("Lote-Serial: 3010328-AA265M0516 y 3010328-AA265M0515");
            DateTime taxPointDate = invoice.TaxPointDate;
            taxPointDate.Year.Should().Be(2021);
            taxPointDate.Month.Should().Be(3);
            taxPointDate.Day.Should().Be(19);
            ...
            ((DateTime)delivery[0].ActualDeliveryDate).Year.Should().Be(2021);
            ((DateTime)delivery[0].ActualDeliveryDate).Month.Should().Be(3);
            ((DateTime)delivery[0].ActualDeliveryDate).Day.Should().Be(19);
            ((DateTime)delivery[0].ActualDeliveryTime).Hour.Should().Be(23);
            ((DateTime)delivery[0].ActualDeliveryTime).Minute.Should().Be(29);
            ((DateTime)delivery[0].ActualDeliveryTime).Second.Should().Be(00);
            ...
            ((DateTime)invoice.PaymentMeans[0].PaymentDueDate).Year.Should().Be(2021);
            ((DateTime)invoice.PaymentMeans[0].PaymentDueDate).Month.Should().Be(4);
            ((DateTime)invoice.PaymentMeans[0].PaymentDueDate).Day.Should().Be(3);
            ...
            ((DateTime)invoice.PrepaidPayment[0].ReceivedDate).Year.Should().Be(2021);
            ((DateTime)invoice.PrepaidPayment[0].ReceivedDate).Month.Should().Be(3);
            ((DateTime)invoice.PrepaidPayment[0].ReceivedDate).Day.Should().Be(19);
