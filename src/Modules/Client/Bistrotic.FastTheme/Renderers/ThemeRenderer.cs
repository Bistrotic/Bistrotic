namespace Bistrotic.FastTheme.Renderers
{
    ...
    public abstract record ThemeRenderer : FastAndFluentComponentRendererBase<Theme>
    {
        private readonly string _scriptName;

        public ThemeRenderer(string themeName, string scriptName) : base(themeName, themeName.ToLowerInvariant() + "-design-system-provider")
        {
        ...
        protected override int RenderElement(int sequence, BlazorComponent blazorComponent, RenderTreeBuilder builder)
        {
            ...
            builder.AddAttribute(sequence++, "src", _scriptName);
