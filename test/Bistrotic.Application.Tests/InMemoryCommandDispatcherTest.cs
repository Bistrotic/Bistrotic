namespace Bistrotic.Application.Tests
{
    ...
    public class InMemoryCommandDispatcherTest
    {
        ...
        public async Task Dispatch_command()
        {
            ...
            await dispatcher
                .Dispatch(new Envelope<Command1>(new Command1(), new MessageId(), new UserName("User 1")));
            await dispatcher
                .Dispatch(new Envelope<Command2>(new Command2(), new MessageId(), new UserName("User 2")));
            await dispatcher
                .Dispatch(new Envelope<Command3>(new Command3(), new MessageId(), new UserName("User 3")));
            await dispatcher
                .Dispatch(new Envelope<Command4>(new Command4(), new MessageId(), new UserName("User 4")));
