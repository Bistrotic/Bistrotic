namespace Bistrotic.Tools
{
    ...
    internal static class Program
    {
        ...
        private static void CreateCertificate(KeyType keyType)
        {
            ...
            var request = new CertificateRequest($"CN=Bistrotic {keyType} Authority", algorithm, HashAlgorithmName.SHA256, RSASignaturePadding.Pkcs1);
            ...
            {
                certificate.FriendlyName = $"Bistrotic OpenId {keyType} Certificate";
            }
            ...
            var data = certificate.Export(X509ContentType.Pfx, "Bistrotic_45AZER");
            WriteToFile($"{nameof(Bistrotic)}{keyType}Certificate.pfx", data);
        }
