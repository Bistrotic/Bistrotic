namespace Fiveforty.Domain
{
    ...
    internal class StateInitializationException : Exception
    {
        ...
        public StateInitializationException(string? message) : this(null, null, message)
        {
        }
        ...
        public StateInitializationException(string? message, Exception? innerException) : this(null, null, message, innerException)
        {
        }

        protected StateInitializationException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
    }
}